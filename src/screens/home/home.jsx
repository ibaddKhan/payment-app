  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="content"
          className="p-5 shadow-2xl rounded-lg w-full max-w-6xl"
        >
          ...
          <ol className="list-decimal space-y-6 pl-5 mb-4">
            ...
            <li>
              <div className="font-bold">Login to your PayPal account</div>{" "}
              Enter your PayPal credentials to sign in and confirm payment.
            </li>
            <li>
              <div className="font-bold">Confirm and pay the bill</div> Check
              your payment details and click ‘Confirm’ to complete the
              transaction. You will receive a confirmation email from Pay Boost
              Bills and PayPal.
            </li>
          </ol>
